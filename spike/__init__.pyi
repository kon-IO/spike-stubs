...
class App:
    ...
    def play_sound(self, name: _AppSound, volume: int = 100) -> None:
        ...
        volume : int, optional
            The volume at which the sound will be played (0 to 100), by default 100

        Raises
        ------
        TypeError
            name is not a string or volume is not an integer.
        RuntimeError
            The SPIKE App has been disconnected from the Hub.
    ...
    def start_sound(self, name: _AppSound, volume: int = 100) -> None:
